...
public interface AttendeeRepository extends JpaRepository<Attendee, Long> {
    ...
    @Query(value = "SELECT atda.id as AttendanceId, atdee.id as AttendeeId, atdee.name as AttendeeName, atdee.note as AttendeeNote, atda.status as AttendanceStatus, atda.created_at as AttendanceTime \n"
